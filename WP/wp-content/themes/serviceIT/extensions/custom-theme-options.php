	...
	class Redux_Framework_sample_config {
		...
		public function setSections() {
			...
			*/
			...
			$this->sections[] = array(
				'title'		=> __('Rodapé'),
				'desc'		=> '<p class="description">'.__('Informações adicionais').'</p>',
				'fields'	=> array(
					array(// Twitter
						'id'		=> $themePrefix . 'developed',
						'type'		=> 'text',
						'title'		=> 'Autor',
						'subtitle'	=> __('Autor do site.'),
						'default'	=> 'Desenvolvido por <b>Vitor Henrique da Silva</b>'
					),
				)
			);
